...
alias resume_send="test -f ~/Téléchargements/resume.pdf && mv ~/Téléchargements/resume.pdf ~/lab/resume/resume.pdf; rsync -vPh ~/lab/resume/resume.pdf drakirus@drakirus.com:APP/data/www/resume --rsh='ssh -p2242'"
alias mv="mv -iv"
alias cp="cp -aiv"
alias py="python"
alias py2="python2"
